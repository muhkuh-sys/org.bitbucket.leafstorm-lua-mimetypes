...
#
tSrcArchive = tarfile.open('leafstorm-lua-mimetypes-02100ff1171e.tar.bz2', 'r')
tSrcArchive.extractall('targets/depack')
tSrcArchive.close()
strDepackPath = 'targets/depack/leafstorm-lua-mimetypes-02100ff1171e/'
...
strGroup = 'org.bitbucket.leafstorm'
strModule = 'lua-mimetypes'
...
tArcList.AddFiles('lua/',
                  os.path.join(strDepackPath, 'mimetypes.lua'))
